...
const Section = (props: SectionProps) => {
	...
	const dynamicDivStyles = { borderColor: borderColor, backgroundColor: isDragging ? onHoverBackgroundColor : 'transparent' }
	const dynamicTextStyles = { color: isDragging ? onHoverTextColor : '#f3f4f6', transition: 'color 0.3s ease' };
