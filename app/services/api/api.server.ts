...
const API_BASE_URL: string = process.env.INTERNAL_CORPUS_CREATOR_API_URL ?? (() => {
  console.warn('Server: ⚠️ INTERNAL_CORPUS_CREATOR_API_URL not defined, using localhost fallback');
